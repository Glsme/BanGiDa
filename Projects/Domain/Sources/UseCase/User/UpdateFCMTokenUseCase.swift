...
private extension UpdateFCMTokenUseCaseImpl {
    package func saveIfNeeded(_ token: String, for uid: String) async throws {
    ...
    package func storedToken(for uid: String) -> String? {
        let tokens = userDefaults.dictionary(forKey: StorageKey.storedTokensByUID) as? [String: String]
        return tokens?[uid]
    }

    package func store(_ token: String, for uid: String) {
