...
class CommonViewModel {
    ...
    var imageEditing: Observable<Bool> = Observable(false)
    ...
    let selectButtonList = [
        ...
        SelectButtonModel(title: "성장 일기", imageString: "pawprint", r: 169, g: 223, b: 225, alpha: 1, placeholder: "성장 일기를 적어주세요."),
